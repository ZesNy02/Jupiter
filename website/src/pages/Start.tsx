          ...
          <div className="black-box">
              ...
              <div className={"intro-box"}>
                  ...
                  <div>
                      ...
                      <p>
                          Mit dem von Prooph Software GmbH entwickelten Prooph Board kann Jedermann Event-Streams und
                          Prozesse,
                          die zentrale Bestandteile von Event-getriebenen Anwendungen sind, effizient und remote im Team
                          planen.
                      </p>
                  </div>
              </div>
